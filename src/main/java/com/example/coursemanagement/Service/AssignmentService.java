...
public class AssignmentService {
    ...
    // Thêm bài tập mới
    public void addAssignment(String title, String description, int courseId, Date dueDate, String fileName, String filePath) throws SQLException {
        String sql = "INSERT INTO assignments (title, description, course_id, due_date, file_name, file_path) VALUES (?, ?, ?, ?, ?, ?)";
